...
export class MoviesApiService {
  ...
  //   createTenant(movieId: string, stars: number): Observable<ApiResponse<void> | ApiErrorResponse> {
  //     return this.http.post<ApiResponse<void> | ApiErrorResponse>(`${this.baseUrl}/movie?tenantid=${tenant.identifier}`, tenant);
  // }
